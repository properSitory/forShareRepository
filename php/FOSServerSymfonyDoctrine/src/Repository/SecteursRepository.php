...
class SecteursRepository extends ServiceEntityRepository
{
    ...
    public function transform(Secteurs $secteur)
    {
        return [
            'id'    => (int) $secteur->getId(),
            'intitule' => (string) $secteur->getIntitule(),
            'active' => (bool) $secteur->getActive()
        ];
    }
    ...
    public function transformAll()
    {
        ...
        foreach ($secteurs as $secteur) {
            $secteursArray[] = $this->transform($secteur);
        }

        return $secteursArray;
    }
