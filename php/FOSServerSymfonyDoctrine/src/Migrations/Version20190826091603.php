 ...
 */
final class Version20190826091603 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE specialites ADD groupes VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE groupes ADD idspecialite_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE groupes DROP idspecialite_id');
        $this->addSql('ALTER TABLE specialites DROP groupes');
    }
}
