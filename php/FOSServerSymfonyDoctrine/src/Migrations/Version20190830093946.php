 ...
 */
final class Version20190830093946 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE groupes CHANGE annees_link_id annee_link_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE groupes CHANGE annee_link_id annees_link_id INT DEFAULT NULL');
