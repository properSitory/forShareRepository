 ...
 */
final class Version20190825134923 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE groupes DROP apprenants_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE groupes ADD apprenants_id INT DEFAULT NULL');
