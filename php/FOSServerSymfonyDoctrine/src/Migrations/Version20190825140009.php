 ...
 */
final class Version20190825140009 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE groupes CHANGE apprenants_id apprenants_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE groupes CHANGE apprenants_id apprenants_id INT NOT NULL');
    }
}
