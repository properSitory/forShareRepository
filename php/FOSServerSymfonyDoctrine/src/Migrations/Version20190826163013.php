 ...
 */
final class Version20190826163013 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE groupes_apprenants (groupes_id INT NOT NULL, apprenants_id INT NOT NULL, INDEX IDX_36B13C4DD4B7C9BD (apprenants_id), INDEX IDX_36B13C4D305371B (groupes_id), PRIMARY KEY(groupes_id, apprenants_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
